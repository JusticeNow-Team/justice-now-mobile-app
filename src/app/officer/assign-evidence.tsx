...
const styles = StyleSheet.create({
  ...
  stepText: { color: colors.textInverse, fontSize: 12, fontWeight: "800" },
  sectionTitle: {
    flex: 1,
  ...
  caseReference: { color: colors.royal[700], fontSize: 11, fontWeight: "800" },
  ...
  flexOne: { flex: 1 },
  evidenceTitle: { color: colors.navy[800], fontSize: 13.5, fontWeight: "700" },
  ...
  avatarText: { color: colors.textInverse, fontSize: 13, fontWeight: "800" },
  checkerName: { color: colors.navy[800], fontSize: 13.5, fontWeight: "700" },
  ...
  summaryTitle: { color: colors.textInverse, fontSize: 13, fontWeight: "800" },
  summaryText: {
    marginTop: 4,
