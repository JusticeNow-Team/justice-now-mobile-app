...
export default function OtpScreen() {
  ...
  const complete =
    ...
    digits.every((digit) => digit.length === 1 && /^[0-9]$/.test(digit));
  ...
  const verifyCode = async () => {
    ...
    if (!email) {
      ...
      setMessage("The email address is missing. Please return to registration and try again.");
      Alert.alert(
        "Email missing",
    ...
    if (!complete) {
      setMessageType("error");
      setMessage(`Please enter all ${OTP_LENGTH} digits of the verification code.`);
      return;
    }
    ...
    try {
      ...
      console.log("Sending OTP to Supabase:", token);
      ...
      if (!data.user) {
        setMessageType("error");
        setMessage("Supabase did not return a verified user.");
        return;
      }
      ...
      setMessage("Your JusticeNow account has been verified successfully.");
  ...
  const resendCode = async () => {
    ...
    try {
      ...
      Alert.alert("New code sent", `A new verification code has been sent to ${email}.`);
    } catch (error) {
      console.error("OTP resend error:", error);
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.missingContainer}>
          ...
          <Text style={styles.description}>
            JusticeNow could not determine which account needs verification. Please
            return to registration and try again.
          </Text>
          <Pressable
          ...
          >
            <Text style={styles.returnButtonText}>Return to registration</Text>
          </Pressable>
        </View>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>Step 2 of 2 · Email confirmation</Text>
        </View>
      </View>
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.title}>Enter the 8-digit code</Text>
          <Text style={styles.description}>
            We sent a verification code to <Text style={styles.bold}>{email}</Text>. Enter
            it below to activate your JusticeNow account.
          </Text>
          ...
          >
            {resending ? (
              ...
              <Text style={styles.linkText}>Send the code again</Text>
            )}
          </Pressable>
        </View>
        ...
        <View style={styles.warning}>
          ...
          <View style={styles.warningContent}>
            <Text style={styles.warningTitle}>Keep this code private</Text>
            <Text style={styles.warningText}>
              JusticeNow staff will never ask you for this verification code by phone,
              email or message.
            </Text>
          </View>
        </View>
